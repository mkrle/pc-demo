...
resource "azurerm_federated_identity_credential" "cnappdemo" {
  ...
  # subject             = "system:serviceaccount:${kubernetes_service_account.workload_identity_sa.metadata[0].namespace}:${kubernetes_service_account.workload_identity_sa.metadata[0].name}"
